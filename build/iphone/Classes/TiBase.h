...
// in simulator we redefine to format for QuickNotes Developer console
...
{\
	NSString * exceptionName = [@"org.quicknotes." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.quicknotes";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIQuickNotesNativeItemNone = -1, 
	UIQuickNotesNativeItemSpinner = -2,
	UIQuickNotesNativeItemProgressBar = -3,
	
	UIQuickNotesNativeItemSlider = -4,
	UIQuickNotesNativeItemSwitch = -5,
	UIQuickNotesNativeItemMultiButton = -6,
	UIQuickNotesNativeItemSegmented = -7,
	
	UIQuickNotesNativeItemTextView = -8,
	UIQuickNotesNativeItemTextField = -9,
	UIQuickNotesNativeItemSearchBar = -10,
	
	UIQuickNotesNativeItemPicker = -11,
	UIQuickNotesNativeItemDatePicker = -12,
	
	UIQuickNotesNativeItemInfoLight = -13,
	UIQuickNotesNativeItemInfoDark = -14,
	
	UIQuickNotesNativeItemDisclosure = -15,
	
	UIQuickNotesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all QuickNotes instances of
