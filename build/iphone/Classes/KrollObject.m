 ...
 * Copyright (c) 2009-2011 by QuickNotes, Inc. All Rights Reserved.
...
//@interface QuickNotesObject : NSObject
//@end

@interface QuickNotesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[QuickNotesObject class]])
		{
			for (NSString *key in [[(QuickNotesObject*)o modules] allKeys])
			{
