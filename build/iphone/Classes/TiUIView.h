...
/**
 Base class for all QuickNotes views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the QuickNotes view hierarchy (such as wrapped iOS UIViews) was touched.
