...
@interface QuickNotesObject : KrollCoverageObject {
#else
@interface QuickNotesObject : KrollObject {
#endif
@private
...
extern NSString * QuickNotes$ModuleRequireFormat;
